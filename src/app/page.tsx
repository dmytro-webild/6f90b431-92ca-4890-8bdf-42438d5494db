...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Governance Expert",          handle: "Board Support",          testimonial: "Exceptional insight into board administration and regulatory compliance.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-optimistic-businessman-formalwear_1262-3600.jpg"},
        {
          name: "Company Secretary",          handle: "Governance Advisory",          testimonial: "Tshakazi Consulting provides the gold standard in boardpack preparation.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/elderly-businessman-with-laptop_23-2148116267.jpg"},
        {
          name: "Board Chair",          handle: "Strategic Partner",          testimonial: "Highly professional delivery of complex statutory governance frameworks.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/positive-middle-aged-business-leader-window_1262-5388.jpg"},
        {
          name: "General Counsel",          handle: "Compliance Lead",          testimonial: "Deep knowledge of the Companies Act and King IV compliance.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-smiling-businesswoman_329181-11700.jpg"},
        {
          name: "Operations Executive",          handle: "Admin Support",          testimonial: "Reliable and discreet governance advisory services.",          rating: 5,
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/indoor-shot-attractive-caucasian-teenage-woman-with-long-dark-hair-sitting-desk-with-lots-textbooks_273609-1136.jpg",          alt: "Indoor shot of attractive Caucasian teenage woman with long dark hair sitting at desk with lots of textbooks"},
      ]}
  ...
  <div id="about" data-section="about">
      ...
      metrics={[
        {
          title: "Years Combined Experience",          value: "10+"},
        {
          title: "Jurisdiction Coverage",          value: "Multi"},
        {
          title: "Professional Memberships",          value: "IoDSA"},
      ]}
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Corporate Secretarial",          description: "Minute taking, board pack preparation, and drafting complex resolutions.",          icon: FileText,
          mediaItems: [
            {
        ...
        {
          title: "Company Administration",          description: "Seamless company registrations, CIPC compliance, and statutory record management.",          icon: Building,
          mediaItems: [
            {
        ...
        {
          title: "Governance Support",          description: "Director reviews, governance frameworks, and professional policy drafting.",          icon: ShieldCheck,
          mediaItems: [
            {
        ...
        {
          title: "Meeting Management",          description: "Board meeting coordination, end-to-end agenda preparation, and tracking matters arising.",          icon: Calendar,
          mediaItems: [
            {
  ...
  <div id="why-us" data-section="why-us">
      ...
      metrics={[
        {
          id: "w1",          title: "King IV Adherence",          value: "100%",          icon: CheckCircle,
        },
        {
          id: "w2",          title: "Regulatory Knowledge",          value: "Expert",          icon: Globe,
        },
        {
          id: "w3",          title: "Confidentiality Policy",          value: "Strict",          icon: Lock,
        },
      ]}
  ...
  <div id="clients" data-section="clients">
      ...
      useInvertedBackground={false}
      names={[
        "Mapongwana Attorneys",        "Bokamoso Education Trust",        "National Health Laboratory Service",        "Global Governance Group",        "African Board Services",        "Compliance Institute SA",        "Corporate Secretarial Solutions"]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "t1",          name: "Thabo M.",          handle: "Managing Partner",          testimonial: "Tshakazi transformed our board administrative efficiency.",          imageSrc: "http://img.b2bpic.net/free-photo/smiling-businessman-standing-airport_107420-85035.jpg"},
        {
          id: "t2",          name: "Sarah K.",          handle: "Board Secretary",          testimonial: "Expert knowledge that saved our compliance timeline.",          imageSrc: "http://img.b2bpic.net/free-photo/blue-eyed-business-woman-white-blouse-standing-confident-pose-with-her-international-co-workers-indoor-portrait-asian-african-employees-with-blonde-lady_197531-3756.jpg"},
        {
          id: "t3",          name: "Jacob V.",          handle: "CEO",          testimonial: "Professional, punctual, and deep governance insight.",          imageSrc: "http://img.b2bpic.net/free-photo/cheerful-young-businesswoman-wearing-eyeglasses_1262-4761.jpg"},
        {
          id: "t4",          name: "Elena R.",          handle: "Director",          testimonial: "The best partner for King IV advisory in the sector.",          imageSrc: "http://img.b2bpic.net/free-photo/serious-executive-with-short-hair-crossed-arms_1149-89.jpg"},
        {
          id: "t5",          name: "Marcus L.",          handle: "General Counsel",          testimonial: "Consistent delivery and highly professional staff.",          imageSrc: "http://img.b2bpic.net/free-photo/confident-handsome-middle-aged-entrepreneur_1262-4871.jpg"},
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",          title: "Which jurisdictions do you cover?",          content: "We provide support across South Africa and various SADC countries."},
        {
          id: "f2",          title: "Are you registered with professional bodies?",          content: "Yes, we are registered with the Chartered Governance Institute of Southern Africa."},
        {
          id: "f3",          title: "How do we book a consultation?",          content: "Use the booking form below or contact our office via phone or email."},
      ]}
